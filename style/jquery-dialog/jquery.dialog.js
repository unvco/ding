    ...
    */
    follow: function (elem) {
        ...
        var fixed = config.fixed,
            ...
            top = fixed ? offset.top - docTop : offset.top+5,
        ...
        if(wrapWidth/2 > winWidth-left-width)
           setLeft = left+width-wrapWidth;
...
artDialog.defaults = {
    ...
    // 消息内容
    content: '<div class="d-loading"><i class="fa fa-spinner fa-spin"></i> Loading...</div>',
