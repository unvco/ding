...
class ShebeiController extends BaseController {

    public function __construct() {
        parent::__construct();
        $hotDiv=(new NewsModel())->selectByLimit(array('bankuai'=>'shebei'),3,'id desc');
        $this->assign('hotDiv',$hotDiv);

        $newDiv=(new NewsModel())->selectByLimit(array('bankuai'=>'shebei'),11,'id desc');
        $this->assign('newDiv',$newDiv);

        $hotDiv2=(new NewsModel())->selectByLimit(array('bankuai'=>'shebei'),10,'look_num desc');
        $this->assign('hotDiv2',$hotDiv2);

        $hotDiv3=(new NewsModel())->selectByLimit(array('bankuai'=>'shebei'),4,'look_num desc');
    ...
    public function lists(){
        $get=I('get.');
        $return=(new NewsLogic())->getNewsLists('shebei',$get);
